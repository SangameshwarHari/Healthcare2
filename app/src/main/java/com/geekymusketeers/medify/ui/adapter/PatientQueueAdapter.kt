...
class PatientQueueAdapter(
    ...
    override fun onBindViewHolder(holder: DoctorAppointmentViewHolder, position: Int) {
        ...
        // Display patient name and phone number if available
        ...
        // Check if token number is null and set it accordingly
        if (currentItem.TokenNumber != null) {
            holder.tokenNumber.text = "Token Number: ${currentItem.TokenNumber}"
            holder.tokenNumber.visibility = View.VISIBLE
        } else {
            holder.tokenNumber.text = "Token Number: Not Assigned"
            holder.tokenNumber.visibility = View.VISIBLE
        }
    ...
    class DoctorAppointmentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tokenNumber: TextView = itemView.findViewById(R.id.tokenNumberDisplay)
    }
